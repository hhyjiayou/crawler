    ...
    <div class="container-fluid nav-padding">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/">
          <img src="/crawler/static/images/files/logo.png" alt="" class="logo"/>
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">xxxx<span class="caret"></span></a>
